...
// Helper: szöveges bekezdés formázás
...
export const generateWordDocument = async (formData) => {
  if (!formData) {
    console.error("Nincs érvényes formData");
    return;
  }
    ...
    sections: [
      {
        ...
        children: [
          ...
          // Tulajdonos adatai
          new Paragraph({ text: "Tulajdonos adatai", heading: HeadingLevel.HEADING_1 }),
          ...
          // Kutya adatai
          new Paragraph({ text: "Kutya adatai", heading: HeadingLevel.HEADING_1 }),
          ...
          // Orvosi adatok
          new Paragraph({ text: "Orvosi adatok", heading: HeadingLevel.HEADING_1 }),
